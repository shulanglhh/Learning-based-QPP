...
data = {}
data["aka_name"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/aka_name.csv', header=None)
data["aka_title"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/aka_title.csv', header=None)
data["cast_info"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/cast_info.csv', header=None)
data["char_name"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/char_name.csv', header=None)
data["company_name"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/company_name.csv', header=None)
data["company_type"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/company_type.csv', header=None)
data["comp_cast_type"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/comp_cast_type.csv', header=None)
data["complete_cast"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/complete_cast.csv', header=None)
data["info_type"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/info_type.csv', header=None)
data["keyword"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/keyword.csv', header=None)
data["kind_type"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/kind_type.csv', header=None)
data["link_type"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/link_type.csv', header=None)
data["movie_companies"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/movie_companies.csv', header=None)
data["movie_info"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/movie_info.csv', header=None)
data["movie_info_idx"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/movie_info_idx.csv', header=None)
data["movie_keyword"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/movie_keyword.csv', header=None)
data["movie_link"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/movie_link.csv', header=None)
data["name"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/name.csv', header=None)
data["person_info"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/person_info.csv', header=None)
data["role_type"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/role_type.csv', header=None)
data["title"] = pd.read_csv('/home/lhh/Learning-based-QPP/test_files_open_source/imdb_data_csv/title.csv', header=None)
...
train_like = {}
with open('/home/lhh/Learning-based-QPP/test_files_open_source/plans_seq.json') as f:
...
pickle.dump(sentences, open('/home/lhh/Learning-based-QPP/test_files_open_source/string_words/more_sentences_train_query.pkl', 'wb'))
