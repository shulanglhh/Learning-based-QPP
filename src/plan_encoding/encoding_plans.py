...
def encode_plan_job(plan, parameters):
    ...
    operators, extra_infos, cardinalities, condition1s, condition2s = [], [], [], [], []
    ...
    for level in nodes_by_level:
        ...
        mapping.append([])
        for node in level:
            operator, extra_info, cardinality, condition1, condition2 = encode_node_job(node.item, parameters)
    ...
    return operators, extra_infos, cardinalities, condition1s, condition2s, mapping
